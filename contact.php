				...
				<div class="modal-body">
					...
					<div class="row gap-20">
						...
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employer" class="btn btn-facebook btn-block mb-5-xs">Employer</a>
						</div>
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employee" class="btn btn-facebook btn-block mb-5-xs">Employee</a>
						</div>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> St.joseph's college <br/> Trichy-2 <br/>Chattiram</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:22ubc530@gmail.com">22ubc530@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+91 6379867556">+91 6379867556</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Jobs_kart</h5>
											<p>Jobs_kart is a job portal, online job management system developed by Ashwin for his project in December 2024.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Jobs_kart Contact</h5>
								
								<p>Address : St.Joseph's college ,Trichy -2</p>
								<p>Email : <a href="mailto:22ubc530@gmail.com">22ubc530@gmail.com</a></p>
								<p>Phone : <a href="tel:+91 637987556">+91 6379867556</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Jobs_kart Vision Software</p>
