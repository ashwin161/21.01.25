...
<head>
    ...
    <meta property="og:image:alt" content="Jobs_kart" />
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="images/Logo.mp4" alt="Logo" /></a>
						</div>
					</div>
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/01.jpg');">
				<div class="container">
					...
					<p>Finding your career on Jobs_kart</p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Phone : <a href="tel:+91 6379867556">+91 6379867556</a></p>
